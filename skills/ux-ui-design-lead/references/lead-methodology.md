...
Use `references/accessibility-checklist.md` for detailed checks.
...
Use `references/design-review-template.md` and `examples/prompts.md` for format patterns.
...
Use `references/icon-semantics-guide.md` for concrete decision trees.
...
Use `references/task-type-playbooks.md` for flow redesign details.
...
Use `references/ux-rubric.md` when a scored review helps prioritization.
...
Use `references/design-review-template.md` for ready-to-fill templates.
...
Use `references/browser-visual-review-workflow.md` for the detailed workflow.
